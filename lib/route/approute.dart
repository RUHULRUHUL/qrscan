...
import 'package:qrscan/feature/view/generate_screens/qr_code_generator_screen.dart';
...
class AppRoute {
  ...
  static const String qrCodeGeneratorScreen = "/qrCodeGeneratorScreen";
  ...
  static List<GetPage> pages = [
    ...
    GetPage(
        name: qrCodeGeneratorScreen, page: () => const QrCodeGeneratorScreen()),
  ];
}
